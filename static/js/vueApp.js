	...
	var app = new Vue({
		...
		methods: {
			...
			exportExcels() {
				...
				excel(dataExcel, ["Tanggal", "Laporan"], "bimbingan");
			},
		},
	});
}
	...
	var app = new Vue({
		...
		methods: {
			...
			exportExcels() {
				...
				excel(dataExcel, ["Tanggal", "Posisi Kerja", "Laporan"], "Tugas");
			},
		},
	});
}
	...
	var app = new Vue({
		...
		methods: {
			...
			exportExcels() {
				...
				excel(dataExcel, ["Tanggal", "Kegiatan", "Peran", "Jumlah Jam", "Laporan"], "Pengembangan");
			},
		},
	});
}
	...
	var app = new Vue({
		...
		methods: {
			...
			exportExcels() {
				...
				excel(dataExcel, ["Tanggal", "Karya", "Laporan"], "Karya Ilmiah");
			},
		},
	});
}
	...
	var app = new Vue({
		...
		methods: {
			...
			exportExcels() {
				...
				excel(dataExcel, ["Tanggal", "Karya", "Laporan"], "Karya Inovatif");
			},
		},
	});
}
